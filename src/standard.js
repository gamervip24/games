...
function X00ActivitiesAdd() {
  ...
  $('<div style="text-align: center;"><span class="label label-primary" style="font-weight: bold;">' + X00Random(1, 255) + '.' + X00Random(1, 255) + '.' + X00Random(1, 255) + '.' + X00Random(1, 255) + '</span> <span class="label label-default" style="font-weight: bold;">has generated</span> <span class="label label-success" style="font-weight: bold;">' + X00Gems[X00Random(0, X00Gems.length)] + ' resources</span> <span id="X00ActivitySeconds" class="label label-info" style="font-weight: bold;">0s ago</span></div>').appendTo('#X00Activities').hide().fadeIn(250);
...
$(function() {
  ...
  $('#X00ButtonStart').click(function() {
    if ($('#X00InputUsername').val() == '') {
	  ...
	  $('#X00Gems2').html($('#X00InputGems2').val());
	  $('#X00Gems3').html($('#X00InputGems3').val());
